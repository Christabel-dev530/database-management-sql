...
try:
  ...
  values  = [
    ('wilson B', 'johndoe@yahoo.com', 'Milo', '22/02/25', '1', '5000'),
    ('Fred M', 'bonfreight@yahoo.com', 'Sugar', '20/02/25', '3', '1700'),
    ('Desire C', 'georgeshepard@yahoo.com', 'Rice', '21/02/25', '2', '2000'),
    ('Chidinma E', 'leejung@yahoo.com', 'Goldenmorn', '21/02/25', '4', '2800'),
]
